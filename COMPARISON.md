...
| **Turbo LoRA** | Wired into generated graphs (6–8 step Sage path). Optional **SLA turbo** (LightX2V 4-step SLA LoRA + PlagueKind H3SLAAttention) is an alternate draft path, not stacked with Sage Pathch / EasyCache / PDD Acc | Supported in their Turbo/AIO variants | Official Turbo sample (8-step, Spectrum off) | Example graph uses LightX2V turbo ~4 step @ 0.75 | Ultra Turbo example workflow |
